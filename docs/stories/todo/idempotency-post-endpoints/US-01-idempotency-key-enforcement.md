...
- Story Slug: `idempotency-key-enforcement`
...
- New version: `1.0.0`
- Bump type: `APPEND`
- Reason: `Appending idempotency key enforcement feature entries to existing 1.0.0 release per user decision`
...
- Ready for review: `Yes`
- Technical Writer sign-off: `Technical Writer, 2026-05-15`
