...
- New version: `1.0.0`
- Bump type: `APPEND`
- Reason: `Sorting feature already listed in 1.0.0 CHANGELOG; no version bump required`

### CHANGELOG Entry

```markdown
## Release 1.0.0 - 2026-05-01
...
- Postman requests updated: `1` request(s)
...
- Version in Directory.Build.props matches confirmed decision: `N/A`
- CHANGELOG entry matches new version and date: `N/A`
...
- Ready for review: `Yes`
- Technical Writer sign-off: `Technical Writer, 2026-05-02`
