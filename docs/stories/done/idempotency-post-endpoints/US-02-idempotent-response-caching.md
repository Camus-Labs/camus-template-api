...
- Story Slug: `idempotent-response-caching`
...
- New version: `1.0.0`
- Bump type: `APPEND`
- Reason: `Entries appended to existing 1.0.0 release section since US-01 and US-02 ship together`
...
- Ready for review: `Yes`
- Technical Writer sign-off: `Technical Writer Agent, 2026-05-16`
