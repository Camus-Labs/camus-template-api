...
4. Inputs
   ...
   - [ ] Missing-input handling is deterministic (infer + state, or ask)
...
8. Structural Consistency
   ...
   - [ ] Heading hierarchy is correct (H1 title, H2 sections, NO H3+
     subsections)
...
9. Writing Quality
   ...
   - [ ] Consistent terminology (same concept uses same word throughout)
