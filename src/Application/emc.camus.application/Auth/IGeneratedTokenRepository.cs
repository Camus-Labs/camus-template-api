...
public interface IGeneratedTokenRepository
{
    ...
    Task<PagedResult<GeneratedToken>> GetPagedByCreatorUserIdAsync(Guid creatorUserId, PaginationParams pagination, GeneratedTokenFilter filter, SortParams<GeneratedTokenSortField> sort, CancellationToken ct = default);
