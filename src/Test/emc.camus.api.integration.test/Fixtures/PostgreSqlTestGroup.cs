...
/// <summary>
/// Collection definition that shares a single <see cref="ApiPostgreSqlFactory"/> (and its
/// Testcontainer) across all PostgreSQL integration test classes. Without this, each class
/// using <c>IClassFixture&lt;ApiPostgreSqlFactory&gt;</c> would start its own container and host,
/// causing parallel <c>WebApplicationFactory&lt;Program&gt;</c> interference.
/// </summary>
[CollectionDefinition(Name)]
public sealed class PostgreSqlTestGroup : ICollectionFixture<ApiPostgreSqlFactory>
{
    /// <summary>
