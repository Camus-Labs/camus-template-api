...
/// <summary>
/// Collection definition that shares a single <see cref="ApiInMemoryFactory"/> across all
...
public sealed class InMemoryTestGroup : ICollectionFixture<ApiInMemoryFactory>
{
    /// <summary>
