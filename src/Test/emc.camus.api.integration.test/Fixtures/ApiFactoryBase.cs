...
public abstract class ApiFactoryBase : WebApplicationFactory<Program>, IAsyncLifetime, ITestOutputHelperAccessor
{
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.UseSetting("RateLimitingSettings:Policies:default:PermitLimit", "10000");
        builder.UseSetting("RateLimitingSettings:Policies:default:WindowSeconds", "60");
        builder.UseSetting("RateLimitingSettings:Policies:strict:PermitLimit", "10000");
        builder.UseSetting("RateLimitingSettings:Policies:strict:WindowSeconds", "60");
        builder.UseSetting("RateLimitingSettings:Policies:relaxed:PermitLimit", "10000");
        builder.UseSetting("RateLimitingSettings:Policies:relaxed:WindowSeconds", "60");
