...
/// </summary>
public sealed partial class ClientIpResolver
{
    ...
    /// </summary>
    /// <param name="logger">Logger for recording IP resolution issues.</param>
    ...
    /// <exception cref="InvalidOperationException">Thrown when the client IP address cannot be determined.</exception>
